<nav class="navbar navbar-main navbar-expand-lg pt-2 px-0 shadow-none border-radius-xl z-index-sticky " id="navbarBlur" data-scroll="false">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav justify-content-end">
                ...
                <li class="nav-item dropdown pe-2 d-flex align-items-center">
                    ...
                    <ul class="dropdown-menu bg-blueGray-300 dropdown-menu-end px-2 py-2 me-sm-n3" aria-labelledby="dropdownMenuButton">
                        <li class="mb-2">
