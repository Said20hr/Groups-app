            ...
            <div class="table-responsive">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="text-xs font-weight-bold">
                    <div class="d-flex align-items-center">
                      <img src="{{asset('dashboards/')}}/assets/img/team-2.jpg" class="avatar avatar-xs me-2" alt="user image">
                ...
                <tr>
                  ...
                  <td class="text-xs font-weight-bold">
                    <div class="d-flex align-items-center">
                      <img src="{{asset('dashboards/')}}/assets/img/team-1.jpg" class="avatar avatar-xs me-2" alt="user image">
                ...
                <tr>
                  ...
                  <td class="text-xs font-weight-bold">
                    <div class="d-flex align-items-center">
                      <div class="d-flex align-items-center">
                        <img src="{{asset('dashboards/')}}/assets/img/team-3.jpg" class="avatar avatar-xs me-2" alt="user image">
                ...
                <tr>
                  ...
                  <td class="text-xs font-weight-bold">
                    <div class="d-flex align-items-center">
                      <div class="d-flex align-items-center">
                        <img src="{{asset('dashboards/')}}/assets/img/team-4.jpg" class="avatar avatar-xs me-2" alt="user image">
                ...
                <tr>
                  ...
                  <td class="text-xs font-weight-bold">
                    <div class="d-flex align-items-center">
                      <div class="d-flex align-items-center">
                        <img src="{{asset('dashboards/')}}/assets/img/team-5.jpg" class="avatar avatar-xs me-2" alt="user image">
                ...
                <tr>
                  ...
                  <td class="text-xs font-weight-bold">
                    <div class="d-flex align-items-center">
                      <div class="d-flex align-items-center">
                        <img src="{{asset('dashboards/')}}/assets/img/ivana-squares.jpg" class="avatar avatar-xs me-2" alt="user image">
