        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-header pb-0">
              <div class="d-lg-flex">
                <div>
                  <h5 class="mb-0">All Groupes</h5>
                </div>
                <div class="ms-auto my-auto mt-lg-0 mt-4">
                  <div class="ms-auto my-auto">
                    <a href="{{ route('admin.groups.create') }}" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; New Group</a>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-sm">
                        ...
                        <a href="{{ route('admin.groups.edit','') }}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit product">
